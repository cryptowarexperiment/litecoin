...
{
    const char* pszTimestamp = "Macedonia";
    const CScript genesisOutputScript = CScript() << ParseHex("04e95fcde32cf95ff01967640a89288a249ffe0e279f16e697a825c13bb2b3936472f031dfdc717f02c7947a5628f5a288f4f58fb833de1822d921d9b147cc6380") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1520862233, 279258, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x75741d27a5e251f6051a77347f6810ed565ddbb3c9f4a3b81eb07afc2670c443"));
        assert(genesis.hashMerkleRoot == uint256S("0x1737c7cf579b85b2f5e510d35b8ae5d68776a6646d29ee8ae42335b34f9f7ace"));
        
        // Note that of those with the service bits flag, most only support a subset of possible options
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.macedonia.loshan.co.uk", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("macedoniatools.com", "dnsseed.macedoniatools.com"));
        //vSeeds.push_back(CDNSSeedData("macedoniapool.org", "dnsseed.macedoniapool.org"));
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 990589, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xf09a8dd34d28f601eea9ef6756fedee882fa8376b96a4522b228d385a0cc1d2b"));
        assert(genesis.hashMerkleRoot == uint256S("0x1737c7cf579b85b2f5e510d35b8ae5d68776a6646d29ee8ae42335b34f9f7ace"));
        
        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        //vSeeds.push_back(CDNSSeedData("macedoniatools.com", "testnet-seed.macedoniatools.com"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.macedonia.loshan.co.uk", true));
...
public:
    CRegTestParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xaa6cf9a1438d51dd48dfd3d330ee848bf2356fa9ae1fd2a0469bd15080c4c12f"));
        assert(genesis.hashMerkleRoot == uint256S("0x1737c7cf579b85b2f5e510d35b8ae5d68776a6646d29ee8ae42335b34f9f7ace"));
