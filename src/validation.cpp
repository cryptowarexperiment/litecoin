...
#if defined(NDEBUG)
# error "Macedonia cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Macedonia Signed Message:\n";
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    if (nHeight == 1) return COIN * 30000;
...
bool CVerifyDB::VerifyDB(const CChainParams& chainparams, CCoinsView *coinsview, int nCheckLevel, int nCheckDepth)
{
    ...
    if (nCheckDepth <= 0)
        // Macedonia: suffices until year 10214. Didn't x4 value due to integer wrap around and upstream compatibility.
